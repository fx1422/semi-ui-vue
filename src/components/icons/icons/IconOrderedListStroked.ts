...
const SvgComponent = defineComponent({
    name: 'IconOrderedListStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconOrderedListStroked;
