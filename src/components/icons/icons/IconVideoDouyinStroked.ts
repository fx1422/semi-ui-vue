...
const SvgComponent = defineComponent({
    name: 'IconVideoDouyinStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconVideoDouyinStroked;
