...
const SvgComponent = defineComponent({
    name: 'IconAlignVCenterStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconAlignVCenterStroked;
