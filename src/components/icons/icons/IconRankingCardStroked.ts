...
const SvgComponent = defineComponent({
    name: 'IconRankingCardStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconRankingCardStroked;
