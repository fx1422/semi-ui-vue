...
const SvgComponent = defineComponent({
    name: 'IconAlignCenterVerticalSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconAlignCenterVertical;
