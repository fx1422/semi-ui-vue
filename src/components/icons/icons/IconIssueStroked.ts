    ...
    setup() {
        return () =>
            h('svg', {
                ...
                focusable: false,
                'aria-hidden': true,
                innerHTML: `<g clip-path="url(#clip0_1477_35)">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 18.5C12.6904 18.5 13.25 17.9404 13.25 17.25C13.25 16.5597 12.6904 16 12 16C11.3097 16 10.75 16.5597 10.75 17.25C10.75 17.9404 11.3097 18.5 12 18.5Z" fill="currentColor"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 4.875C12.6213 4.875 13.125 5.37868 13.125 6V14C13.125 14.6213 12.6213 15.125 12 15.125C11.3787 15.125 10.875 14.6213 10.875 14V6C10.875 5.37868 11.3787 4.875 12 4.875Z" fill="currentColor"/>
</g>
<defs>
...
const IconIssueStroked = defineComponent({
...
export default IconIssueStroked;
