...
const SvgComponent = defineComponent({
    name: 'IconMoneyExchangeStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconMoneyExchangeStroked;
