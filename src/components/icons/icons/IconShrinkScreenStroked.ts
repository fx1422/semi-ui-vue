...
const SvgComponent = defineComponent({
    name: 'IconShrinkScreenStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconShrinkScreenStroked;
