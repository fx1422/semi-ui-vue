...
const SvgComponent = defineComponent({
    name: 'IconIndependentCornersStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
    ...
    setup(props, { attrs }) {
        return () =>
            h(
                Icon,
                {
                    type: 'independent-corners-stroked',
                    ...attrs,
                },
                {
...
export default IconIndependentCornersStroked;
