...
const SvgComponent = defineComponent({
    name: 'IconCloudUploadStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconCloudUploadStroked;
