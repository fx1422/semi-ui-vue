...
const SvgComponent = defineComponent({
    name: 'IconCandlestickChartStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
    ...
    setup(props, { attrs }) {
        return () =>
            h(
                Icon,
                {
                    type: 'candlestick-chart-stroked',
                    ...attrs,
                },
                {
...
export default IconCandlestickChartStroked;
