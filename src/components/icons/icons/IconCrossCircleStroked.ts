...
const SvgComponent = defineComponent({
    name: 'IconCrossCircleStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconCrossCircleStroked;
