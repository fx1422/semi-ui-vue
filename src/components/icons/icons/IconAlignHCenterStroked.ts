...
const SvgComponent = defineComponent({
    name: 'IconAlignHCenterStrokedSvg',
    setup() {
        return () =>
            h('svg', {
                viewBox: '0 0 24 24',
...
export default IconAlignHCenterStroked;
