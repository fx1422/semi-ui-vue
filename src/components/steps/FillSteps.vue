<template>
    <div :class="wrapperCls" :style="style" :aria-label="props['aria-label']" v-bind="dataAttrs">
...
import type { FillStepsProps } from './interface';

const props = withDefaults(defineProps<FillStepsProps>(), {
...
const colStyle = computed(() => {
    ...
    return { width: `${100 / childrenArray.value.length}%` };
});
